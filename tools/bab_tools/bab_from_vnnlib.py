...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, help='Which .csv experiment to run', default="/data00/home/xuehao.michael/oval-bab/benchmarks/oval21/oval21_instances.csv")
    parser.add_argument('--is_adversarial', action='store_true', help='retrieve info for adv. robustness specifications')
    parser.add_argument('--json', type=str, help='json file storing the BaB settings', default="/data00/home/xuehao.michael/oval-bab/bab_configs/test.json")
    ...
    parser.add_argument('--result_path', type=str, help='path where to store results', default="/data00/home/xuehao.michael/oval-bab/test_results/")
